...
SET ANSI_PADDING ON
GO
-- BANGDIEM luu diem tong cua sinh vien theo mon va lan thi.
CREATE TABLE [dbo].[BANGDIEM](
	[MASV] [nchar](8) NOT NULL,
	[MAMH] [nchar](5) NOT NULL,
	[LAN] [smallint] NOT NULL,
	[NGAYTHI] [date] NULL CONSTRAINT [DF_BANGDIEM_NGAYTHI] DEFAULT (getdate()),
	[DIEM] [float] NULL,
...
SET ANSI_PADDING ON
GO
-- BODE la ngan hang cau hoi trac nghiem, moi cau thuoc mot mon va mot trinh do.
...
SET ANSI_PADDING ON
GO
-- CT_BAITHI luu tung cau trong bai thi de xem lai va khoa sua/xoa cau da thi.
...
(
 ...
 CONSTRAINT [UQ_CT_BAITHI_CAUHOI] UNIQUE NONCLUSTERED
(
    [MASV] ASC,
    [MAMH] ASC,
    [LAN] ASC,
...
SET ANSI_PADDING ON
GO
-- BAITHI_TAM luu dau bai thi dang lam de khoi phuc neu gap su co.
CREATE TABLE [dbo].[BAITHI_TAM](
 ...
 CONSTRAINT [PK_BAITHI_TAM] PRIMARY KEY CLUSTERED
(
    [MASV] ASC,
    [MAMH] ASC,
    [LAN] ASC
...
SET ANSI_PADDING ON
GO
-- CT_BAITHI_TAM luu tung cau da boc va dap an tam cua sinh vien.
CREATE TABLE [dbo].[CT_BAITHI_TAM](
    ...
    [CAUHOI] [int] NOT NULL,
    [DAP_AN_SV] [char](1) NULL,
 CONSTRAINT [PK_CT_BAITHI_TAM] PRIMARY KEY CLUSTERED
(
    [MASV] ASC,
    [MAMH] ASC,
    [LAN] ASC,
 ...
 CONSTRAINT [UQ_CT_BAITHI_TAM_CAUHOI] UNIQUE NONCLUSTERED
(
    [MASV] ASC,
    [MAMH] ASC,
    [LAN] ASC,
...
SET ANSI_PADDING ON
GO
-- GIAOVIEN luu thong tin giao vien, dung lien ket voi cau hoi va lich dang ky thi.
...
SET ANSI_PADDING ON
GO
-- GIAOVIEN_DANGKY luu lich thi cua lop theo mon, lan thi, ngay thi va so cau.
...
SET QUOTED_IDENTIFIER ON
GO
-- LOP luu danh sach lop, dung de quan ly sinh vien va lich thi theo lop.
...
SET ANSI_PADDING ON
GO
-- MONHOC luu danh sach mon thi trac nghiem.
...
SET ANSI_PADDING ON
GO
-- SINHVIEN luu thong tin sinh vien va lop cua sinh vien.
...
SET ANSI_PADDING OFF
GO
-- Du lieu mau ben duoi dung de test nhanh bo de, lop, mon hoc va sinh vien.
...
-- Cac khoa ngoai va CHECK ben duoi giu du lieu dung rang buoc cua de tai.
...
GO
ALTER TABLE [dbo].[GIAOVIEN_DANGKY]  WITH CHECK ADD  CONSTRAINT [CK_THOIGIAN] CHECK  (([THOIGIAN]>=(5) AND [THOIGIAN]<=(60)))
GO
...
GO
ALTER TABLE [dbo].[MONHOC] ADD CONSTRAINT [UQ_MONHOC_TENMH] UNIQUE ([TENMH])
GO
ALTER TABLE [dbo].[CT_BAITHI] WITH CHECK ADD CONSTRAINT [FK_CT_BAITHI_BANGDIEM] FOREIGN KEY([MASV], [MAMH], [LAN])
...
GO
ALTER TABLE [dbo].[CT_BAITHI] WITH CHECK ADD CONSTRAINT [CK_CT_BAITHI_DAP_AN_SV] CHECK (([DAP_AN_SV] IS NULL OR [DAP_AN_SV]='D' OR [DAP_AN_SV]='C' OR [DAP_AN_SV]='B' OR [DAP_AN_SV]='A'))
GO
ALTER TABLE [dbo].[CT_BAITHI] CHECK CONSTRAINT [CK_CT_BAITHI_DAP_AN_SV]
GO
ALTER TABLE [dbo].[BAITHI_TAM] WITH CHECK ADD CONSTRAINT [FK_BAITHI_TAM_SINHVIEN] FOREIGN KEY([MASV])
REFERENCES [dbo].[SINHVIEN] ([MASV])
GO
ALTER TABLE [dbo].[BAITHI_TAM] CHECK CONSTRAINT [FK_BAITHI_TAM_SINHVIEN]
GO
ALTER TABLE [dbo].[BAITHI_TAM] WITH CHECK ADD CONSTRAINT [FK_BAITHI_TAM_MONHOC] FOREIGN KEY([MAMH])
REFERENCES [dbo].[MONHOC] ([MAMH])
GO
ALTER TABLE [dbo].[BAITHI_TAM] CHECK CONSTRAINT [FK_BAITHI_TAM_MONHOC]
GO
ALTER TABLE [dbo].[BAITHI_TAM] WITH CHECK ADD CONSTRAINT [FK_BAITHI_TAM_DANGKY] FOREIGN KEY([MALOP], [MAMH], [LAN])
REFERENCES [dbo].[GIAOVIEN_DANGKY] ([MALOP], [MAMH], [LAN])
GO
ALTER TABLE [dbo].[BAITHI_TAM] CHECK CONSTRAINT [FK_BAITHI_TAM_DANGKY]
GO
ALTER TABLE [dbo].[CT_BAITHI_TAM] WITH CHECK ADD CONSTRAINT [FK_CT_BAITHI_TAM_HEADER] FOREIGN KEY([MASV], [MAMH], [LAN])
REFERENCES [dbo].[BAITHI_TAM] ([MASV], [MAMH], [LAN])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[CT_BAITHI_TAM] CHECK CONSTRAINT [FK_CT_BAITHI_TAM_HEADER]
GO
ALTER TABLE [dbo].[CT_BAITHI_TAM] WITH CHECK ADD CONSTRAINT [FK_CT_BAITHI_TAM_BODE] FOREIGN KEY([CAUHOI])
REFERENCES [dbo].[BODE] ([CAUHOI])
GO
ALTER TABLE [dbo].[CT_BAITHI_TAM] CHECK CONSTRAINT [FK_CT_BAITHI_TAM_BODE]
GO
ALTER TABLE [dbo].[BAITHI_TAM] WITH CHECK ADD CONSTRAINT [CK_BAITHI_TAM_TRINHDO] CHECK (([TRINHDO]='C' OR [TRINHDO]='B' OR [TRINHDO]='A'))
GO
ALTER TABLE [dbo].[BAITHI_TAM] CHECK CONSTRAINT [CK_BAITHI_TAM_TRINHDO]
GO
ALTER TABLE [dbo].[BAITHI_TAM] WITH CHECK ADD CONSTRAINT [CK_BAITHI_TAM_THOIGIANCONLAI] CHECK (([THOIGIANCONLAI]>=(0)))
GO
ALTER TABLE [dbo].[BAITHI_TAM] CHECK CONSTRAINT [CK_BAITHI_TAM_THOIGIANCONLAI]
GO
ALTER TABLE [dbo].[CT_BAITHI_TAM] WITH CHECK ADD CONSTRAINT [CK_CT_BAITHI_TAM_DAP_AN_SV] CHECK (([DAP_AN_SV] IS NULL OR [DAP_AN_SV]='D' OR [DAP_AN_SV]='C' OR [DAP_AN_SV]='B' OR [DAP_AN_SV]='A'))
GO
ALTER TABLE [dbo].[CT_BAITHI_TAM] CHECK CONSTRAINT [CK_CT_BAITHI_TAM_DAP_AN_SV]
GO
USE [master]
GO
